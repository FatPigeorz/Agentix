...
| Path | Purpose |
| --- | --- |
| `agentix/invoke` | Function binding, shape detection, validation, invocation |
...
| `agentix/runtime/server` | FastAPI app, Socket.IO handlers, worker client, worker process |
| `agentix/deployment` | Deployment protocol and backend discovery |
| `agentix/cli` | Build and deploy commands |
